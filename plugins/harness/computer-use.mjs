...
const COMPUTER_USE_SPEC = '@deepseek-ai/dsh-computer-use@0.1.6-alpha.1'
const CUA_DRIVER_NATIVE_SPEC = '@deepseek-ai/dsh-experimental-computer-use-cua-driver-native@0.1.6-alpha.1'
