 ...
 * 的精确版本（dsh-flowglass@0.4.5、dsh-sidebar-qa@0.5.0），不用 `@latest`：
...
// 注册为原生会话级 tab。v0.4.5 已适配 rc.1 client 运行时（peer 指向
// ^0.1.2-alpha.1，覆盖 0.1.2-rc.1；不再 require 被 alpha.1 移除的
// @deepseek-ai/dsh-client-runtime），所以不再默认跳过。版本 pin 到子模块 tag
// v0.4.5 对应的 npm 发布。
installNpmPlugin({
  id: 'flowglass',
  packageSpec: 'dsh-flowglass@0.4.5',
})
