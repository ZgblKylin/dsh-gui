...
//
// 来源：git submodule（plugins/dsh-pet/dsh-pet，pin 最新版本 tag v0.2.4，
//   仅作源码参考，不参与构建）；安装走 npm（installNpmPlugin，精确版本
//   dsh-pet@0.2.4），与 dsh-web-ui 等 npm 型 wrapper 同一通道。
//
// 兼容性（与 @linxin666/dsh-pet 同因，默认跳过）：
//   - dsh-pet 0.2.4 的 client 半按旧 harness 构建，运行时 require
//     `@deepseek-ai/dsh-client-runtime`（本仓库 pin 的 dsh-v0.1.2-alpha.1 已
